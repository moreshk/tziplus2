...
def plot_chart_v2(tickerData, fvg_list, demand_zones, supply_zones, major_highs, major_lows, tickerSymbol):
    ...
    if len(tickerData) > 1:
        ...
        data_interval = pd.Timedelta(minutes=15)  # Default to 15 minutes if we can't calculate
