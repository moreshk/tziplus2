...
csv_file_path = 'sector_analysis/sector_data/output/volatile_tickers.csv'
...
output_csv_path = 'sector_analysis/sector_data/output/volatile_with_demand_supply_bottom_2.csv'
